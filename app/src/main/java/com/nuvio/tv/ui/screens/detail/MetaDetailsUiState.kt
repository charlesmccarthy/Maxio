...
data class MetaDetailsUiState(
    ...
    val trailerBackgroundMode: Boolean = false,
    val backgroundTrailerUrl: String? = null,
    val backgroundTrailerAudioUrl: String? = null,
    val backgroundTrailerSeekMs: Long = 0L,
